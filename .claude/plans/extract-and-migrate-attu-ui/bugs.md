...
- [nit] debt-03: Button.svelte exists in both apps/tree-editor/src/lib/components/ui/ and packages/attu-ui → fix-in-phase-3 · intentional duplicate window per plan; local copy deleted during phase 3 import migration
