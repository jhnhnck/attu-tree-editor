...
<dialog
    ...
    {onclose}
    onclick={onBackdrop}
    class="m-auto w-[640px] overflow-hidden rounded-lg border border-line bg-canvas-elev p-0 text-fg shadow-xl backdrop:bg-black/50 backdrop:backdrop-blur-sm"
>
    <div class="flex max-h-[80vh] flex-col">
        <!-- header -->
        <div class="flex shrink-0 items-center justify-between border-b border-line px-6 py-4">
            <h2 class="text-base font-semibold text-fg">Preferences</h2>
            <button type="button" onclick={closeModal} class="text-fg-muted hover:text-fg">
        ...
        <!-- footer -->
        <div class="flex shrink-0 items-center justify-end border-t border-line px-6 py-3">
            <button
                type="button"
                onclick={closeModal}
